...
function changeClass() {
	...
	if(mq.matches) {
		...
		for(var i = 0; i < x.length; i++){
			...
			//document.querySelector(".hiddenDetails").style.display = "block";
		//	document.querySelector(".hiddenDetails").classList.remove("karim");
			//document.querySelector(".hiddenDetails").style.opacity = "1";
		}
	...
	if(mq.matches) {
		...
		for(var ii = 0; ii < x2.length; ii++){
				...
				x2[ii].setAttribute("class", "mySlides hiddenSlides"); // hiddenSlides
		...
		var x2 = document.querySelectorAll(".hiddenSlides"); // hiddenSlidea
		
		for(var ii = 0; ii < x2.length; ii++){
			
				x2[ii].setAttribute("class", "mySlides2");
				
			x2[ii].style.display="none";
		/*	document.querySelector(".karim").setAttribute("class", "mySlides");
			document.querySelector(".karim").style.display = "block"; */
			setInterval(function() {
				if(mq.matches) {
					x2[ii].style.display="block";
					//x2[ii].style.opacity="1";
				}
			}, 10)
			}
		
	//	document.querySelectorAll(".mySlides").style.display = "inline-block";
			}
...
window.onload = function(){ 
	...
	document.querySelector(".runningMan").style.display = "none" ;
	document.querySelector(".runningMan").style.opacity = "0" ;
...
document.onreadystatechange = function () {
            if (document.readyState === "complete") {
               ...
               document.querySelector(".runningMan").style.display = "none";
                ...
                document.getElementById("runningMan").style.display = "none";
				document.body.style.overflowY = "visible";
				document.getElementById("allBody").style.opacity = "1"; 
				$(".runningMan").css("display", "none");
            }
